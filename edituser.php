...
$result=mysqli_query($con,"select id,firstname,lastname, email, password from client where id='$user_id'")or die ("query 1 incorrect.......");

list($id,$firstname,$lastname,$email,$password)=mysqli_fetch_array($result);
...
mysqli_query($con,"update client set firstname='$firstname', lastname='$lastname', email='$email', password='$password' where user_id='$user_id'")or die("Query 2 is inncorrect..........");
